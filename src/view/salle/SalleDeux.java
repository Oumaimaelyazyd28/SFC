...
public class SalleDeux extends JFrame{
    ...
    public SalleDeux() {
        setContentPane(salle2Panel);
        setMinimumSize(new Dimension(900,650));
        setLocationRelativeTo(null);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        pack();
        setVisible(true);
        DBtemperature.importData(table1, "src/view/files/test.txt","Temperature de la salle 2");
        DBhumidite.importData(table2,"src/view/files/humidite1.txt","Humidité de la salle 2");

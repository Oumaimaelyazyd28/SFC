...
public class SalleQuatre extends JFrame{
    private JTable table1;
    private JButton activerButton;
    private JButton desactiverButton;
    private JPanel salle4Panel;
    ...
    public SalleQuatre() {
        setContentPane(salle4Panel);
        setMinimumSize(new Dimension(900,650));
        setLocationRelativeTo(null);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        pack();
        setVisible(true);
        DBtemperature.importData(table1, "src/view/files/test.txt","Temperature de la salle 4");
        DBhumidite.importData(table2,"src/view/files/humidite1.txt","Humidité de la salle 4");

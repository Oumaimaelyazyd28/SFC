...
public class SalleCinq extends JFrame{
    ...
    public SalleCinq() {
        setContentPane(salle5Panel);
        setMinimumSize(new Dimension(900,650));
        setLocationRelativeTo(null);
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        pack();
        setVisible(true);
        DBtemperature.importData(table1, "src/view/files/test.txt","Temperature de la salle 5");
        DBhumidite.importData(table2,"src/view/files/humidite1.txt","Humidité de la salle 5");
